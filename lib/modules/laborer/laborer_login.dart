...
class LaborerLoginScreen extends StatefulWidget {
  const LaborerLoginScreen({super.key});

  @override
  _LaborerLoginScreenState createState() => _LaborerLoginScreenState();
}

class _LaborerLoginScreenState extends State<LaborerLoginScreen> {
    ...
    try {
      ...
      if (!userDoc.exists) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Laborer data not found in records.')),
        );
        return;
      }
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => LaborerHomeScreen(),
        ),
      );
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const LaborerSignupScreen(),
                        ),
                      );
                    },
